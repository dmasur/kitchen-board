...
var CalendarComponent = (function (_super) {
    ...
    CalendarComponent.prototype.getDayClass = function (day) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2__services__["a" /* CalendarService */].isToday(day.date)) {
            return 'danger';
        }
        if (__WEBPACK_IMPORTED_MODULE_2__services__["a" /* CalendarService */].isWeekend(day.date)) {
            return 'info';
        }
        return '';
    };
...
CalendarComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3_angular2_cookie_core__["CookieService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angular2_cookie_core__["CookieService"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services__["a" /* CalendarService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["a" /* CalendarService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services__["b" /* AppointmentsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["b" /* AppointmentsService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__services__["c" /* NextEventsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["c" /* NextEventsService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_5__shared_settings__["a" /* Settings */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__shared_settings__["a" /* Settings */]) === "function" && _e || Object])
], CalendarComponent);
...
var AuthenticationService = AuthenticationService_1 = (function () {
    ...
    AuthenticationService.prototype.internalAuthenticate = function (immediate) {
         ...
         * scope.
         */
        return __WEBPACK_IMPORTED_MODULE_2__index__["d" /* WaitService */].waitForIt(gapi, 'client').then(function () {
    ...
    AuthenticationService.prototype.loadGooglePlusUserData = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.execute(function (response) { return _this.setUserData(response.result.displayName, response.result.image.url); });
            resolve();
        }).catch(function (reason) {
